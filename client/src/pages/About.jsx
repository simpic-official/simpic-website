...
const About = () => {
  return (
    <div className='mt-[15em] w-screen flex justify-center'>
      <div className='w-[75vw]'>
        <section>
          <h1 className='text-7xl font-bold text-center lg:text-start'>About SIMPIC</h1>
        ...
        </section>   <section className='flex flex-wrap-reverse lg:flex-nowrap mt-[10em] justify-center items-center'>
